(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu._desk")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu._desk")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
            }
        }));
        if (document.querySelector(".icon-menu._mobile")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu._mobile")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
            }
        }));
    ...
    function onTouchEnd(event) {
        ...
        let rewindLastIndex;
        if (params.rewind) if (swiper.isBeginning) {
            const lastIndex = swiper.params.virtual && swiper.params.virtual.enabled && swiper.virtual ? swiper.virtual.slides.length - 1 : swiper.slides.length - 1;
    ...
    function initSliders() {
        if (document.querySelector(".client__slider") && window.innerWidth < 1050) new core(".client__slider", {
        ...
        if (document.querySelector(".article-slider__slider")) new core(".article-slider__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".article-slide__prev",
                nextEl: ".article-slide__next"
            },
            on: {}
        });
        let thumb = new core(".thumb__initianal", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".more__slider")) new core(".more__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    let counters = document.querySelectorAll(".input_div");
    counters.forEach((counter => {
        let count = 1;
        let countEl = counter.querySelector(".cunt-inpt");
        if (countEl) {
            function plus() {
                count++;
                countEl.value = count;
            ...
            counter.querySelector(".cunt-inpt__plus").addEventListener("click", minus);
            counter.querySelector(".cunt-inpt__minus").addEventListener("click", plus);
        }
    }));
    const actualBtn = document.getElementById("actual-btn");
    const fileChosen = document.getElementById("file-chosen");
    if (actualBtn) actualBtn.addEventListener("change", (function() {
